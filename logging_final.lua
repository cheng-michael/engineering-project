...
local sensor_addr = 0x77 -- the sensor has two addresses: 0x76 and 0x77
local T, P, H = {}, {}, {} -- calib coefficient
local p, t, h 
local i2c_bus = i2c:get_device(0, sensor_addr) -- get device handler, bus 3 = i2ca
