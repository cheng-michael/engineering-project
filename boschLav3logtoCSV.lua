...
local function write_to_dataflash()
  ...
  logger:write('SCR1','pressure(Pa),temperature(°C),humidity(%)','fff',data[pp],data[tt],data[hh])

  -- give units and (multipliers)
  logger:write('SCR2','pressure,temperature,humidity','fff','Pa,°C,%','---',data[pp],data[tt],data[hh])
